...
<body class="bg-light ">
    <section class="content">
        <div class="tabs">
            ...
            <a class="tab active" href="doc4.php">ประเภท 5</a>
            ...
            <div class="col-md-12 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="firstp" class="form-label">งวดแรก%</label>
                            <input type="tel" class="form-control" id="firstp" name="firstp" value="0">
                        </div>
                    </div>
                    ...
                    <script>
                        ...
                        function calculateRemainingBalance() {
                            ...
                            var totalInstallments = installmentFields.length;
                            ...
                            // Update installmentField1 based on firstp percentage
                            if (!isNaN(firstp) && firstp > 0 && installmentValues.length > 0) {
                                var firstInstallment = Math.round((money * firstp) / 100);
                                installmentFields[0].value = firstInstallment;
                                installmentValues[0] = firstInstallment;
                            }
